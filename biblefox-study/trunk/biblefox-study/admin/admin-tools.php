...
class BfoxAdminTools
{
	...
	{
		if (is_site_admin()) add_action('admin_menu', array('BfoxAdminTools', 'add_menu'));
	}
...
class BfoxToolbox
{
	...
	public function menu()
	{
		...
		foreach ($tools as $tool) echo '<a href="' . bfox_admin_page_url('bfox_' . $class) . '&amp;tool=' . $tool . '">' . $tool . '</a><br/>';
