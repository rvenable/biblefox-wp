...
class BfoxUserCurrentReadingsWidget extends WP_Widget {
	public function __construct() {
		parent::__construct(false, __('User Current Bible Readings'));
	}
...
add_action('widgets_init', create_function('', 'return register_widget("BfoxUserCurrentReadingsWidget");'));
